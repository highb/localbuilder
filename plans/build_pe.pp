plan localbuilder::build_pe(
  ...
  Optional[String] $output_dir = '/tmp/localbuilder/builds/',
#####################################
...
#####################################
# pe-installer-shim parameters
#####################################
  Optional[String] $pe_installer_shim = undef,
  Optional[String] $pe_installer_shim_pr = undef,
) {
...
######################################
  ...
  run_plan(localbuilder::build_pe_helpers::handle_package_creation, platform => $platform, version => $version, vanagon_project => 'pe-modules-vanagon', local_vanagon_components => $local_pe_modules_params, vanagon_component_prs => $pe_modules_pr_params)
...
########################################
  ...
  run_plan(localbuilder::build_pe_helpers::handle_package_creation, platform => $platform, version => $version, vanagon_project => 'pe-installer-vanagon', local_vanagon_components => $local_pe_installer_params, vanagon_component_prs => $pe_installer_pr_params)
...
###########################################
  ...
  run_plan(localbuilder::build_pe_helpers::handle_package_creation, platform => $platform, version => $version, vanagon_project => 'pe-backup-tools-vanagon', local_vanagon_components => $local_pe_backup_tools_params, vanagon_component_prs => $pe_backup_tools_pr_params)
...
####################################
  ...
  run_plan(localbuilder::build_pe_helpers::handle_package_creation, platform => $platform, version => $version, vanagon_project => 'pe-tasks-vanagon', local_vanagon_components => $local_pe_tasks_params, vanagon_component_prs => $pe_tasks_pr_params)
...
########################
  ...
  run_plan(localbuilder::build_pe_helpers::sign_packages, packages => $packages_list, pe_dir => $pe_dir, platform => $platform, host => $vm)
